;(function () {
  ...
  var getMarkdown = function () {
    return root.marked || (typeof require === 'function' && require('./marked.min'))
  }
  var getAnsi = function () {
    var lib = root.ansi_up || (typeof require === 'function' && require('./ansi_up.min'))
    return lib && lib.ansi_to_html
  }
  var getSanitizer = function () {
    var lib = root.DOMPurify || (typeof require === 'function' && require('./purify.min'))
  ...
  nb.Cell.prototype.renderers = {
    markdown: function () {
      ...
      joined = joined.replace(/\\\\/gms, (match) => {
        return '\\\\\\\\'
      })
